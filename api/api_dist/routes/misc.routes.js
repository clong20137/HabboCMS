...
const miscService = __importStar(require("../services/misc.service"));
exports.miscRouter = express_1.default.Router();
exports.miscRouter.get("/online-count", (0, asyncHandler_1.asyncHandler)(async (_req, res) => {
    try {
        const online = await miscService.onlineCount(db_1.pool);
